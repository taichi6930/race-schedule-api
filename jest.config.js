...
module.exports = {
    ...
    coveragePathIgnorePatterns: [
        ...
        'src/gateway/record/placeGradeRecord.ts',
        'src/repository/*/narRaceRepositoryFromHtml.ts',
        'src/repository/*/autoraceRaceRepositoryFromHtml.ts',
        'src/repository/*/boatraceRaceRepositoryFromHtml.ts',
        'src/repository/*/keirinRaceRepositoryFromHtml.ts',
        'src/repository/*/overseasRaceRepositoryFromHtml.ts',
        'src/repository/*/jraRaceRepositoryFromHtml.ts',
        ...
        'src/repository/implement/raceRepositoryFromStorage.ts',
        'src/service/implement/raceService.ts',
        'src/usecase/implement/calendarUseCase.ts',
