...
const RaceCourseMasterList: {
    ...
    { raceType: RaceType.WORLD, placeName: 'ロンシャン', placeCode: '01' },
    { raceType: RaceType.WORLD, placeName: 'パリロンシャン', placeCode: '02' },
    { raceType: RaceType.WORLD, placeName: 'シャンティイ', placeCode: '03' },
    { raceType: RaceType.WORLD, placeName: 'サンクルー', placeCode: '04' },
    { raceType: RaceType.WORLD, placeName: 'ドーヴィル', placeCode: '05' },
    { raceType: RaceType.WORLD, placeName: 'アスコット', placeCode: '06' },
    {
        raceType: RaceType.WORLD,
        placeName: 'ニューマーケット',
        placeCode: '07',
    },
    { raceType: RaceType.WORLD, placeName: 'ニューベリー', placeCode: '08' },
    { raceType: RaceType.WORLD, placeName: 'エプソム', placeCode: '09' },
    { raceType: RaceType.WORLD, placeName: 'グッドウッド', placeCode: '10' },
    { raceType: RaceType.WORLD, placeName: 'サンダウン', placeCode: '11' },
    { raceType: RaceType.WORLD, placeName: 'ヨーク', placeCode: '12' },
    { raceType: RaceType.WORLD, placeName: 'ヘイドック', placeCode: '13' },
    { raceType: RaceType.WORLD, placeName: 'ドンカスター', placeCode: '14' },
    { raceType: RaceType.WORLD, placeName: 'レパーズタウン', placeCode: '15' },
    { raceType: RaceType.WORLD, placeName: 'カラ', placeCode: '16' },
    {
        raceType: RaceType.WORLD,
    ...
    { raceType: RaceType.WORLD, placeName: 'ピムリコ', placeCode: '20' },
    { raceType: RaceType.WORLD, placeName: 'サラトガ', placeCode: '21' },
    { raceType: RaceType.WORLD, placeName: 'アケダクト', placeCode: '22' },
    { raceType: RaceType.WORLD, placeName: 'モンマスパーク', placeCode: '23' },
    {
        raceType: RaceType.WORLD,
        placeName: 'ベルモントパーク',
        placeCode: '24',
    ...
    { raceType: RaceType.WORLD, placeName: 'デルマー', placeCode: '26' },
    {
        raceType: RaceType.WORLD,
        placeName: 'パークスレーシング',
        placeCode: '27',
    },
    { raceType: RaceType.WORLD, placeName: 'キーンランド', placeCode: '28' },
    {
        raceType: RaceType.WORLD,
        placeName: 'オークローンパーク',
        placeCode: '29',
    },
    { raceType: RaceType.WORLD, placeName: 'ミュンヘン', placeCode: '30' },
    { raceType: RaceType.WORLD, placeName: 'ホッペガルテン', placeCode: '31' },
    {
        raceType: RaceType.WORLD,
        placeName: 'バーデンバーデン',
        placeCode: '32',
    },
    { raceType: RaceType.WORLD, placeName: 'シャティン', placeCode: '33' },
    {
        raceType: RaceType.WORLD,
        placeName: 'キングアブドゥルアジーズ',
        placeCode: '34',
    },
    { raceType: RaceType.WORLD, placeName: 'メイダン', placeCode: '35' },
    { raceType: RaceType.WORLD, placeName: 'ランドウィック', placeCode: '36' },
    { raceType: RaceType.WORLD, placeName: 'コーフィールド', placeCode: '37' },
    { raceType: RaceType.WORLD, placeName: 'フレミントン', placeCode: '38' },
    { raceType: RaceType.WORLD, placeName: 'メルボルン', placeCode: '39' },
    { raceType: RaceType.WORLD, placeName: 'ムーニーバレー', placeCode: '40' },
    {
        raceType: RaceType.WORLD,
