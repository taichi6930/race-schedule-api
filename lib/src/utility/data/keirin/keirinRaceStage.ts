...
export const KeirinRaceGradeAndStageList: {
    ...
    },
    {
        ...
        priority: 8,
        description: 'GⅡレースの若手のグランプリ。若手選手が集結し、将来を担う選手を発掘するレース。',
    },
    { grade: ['GⅡ'],
        stage: 'S級アルタイル賞',
        stageByOddspark: 'Ｓ級ＡＬＴ',
        priority: 8,
        description: 'GⅡレース・サマーナイトフェスティバルの2日目に行われるレース。準決勝のシード選手が出場する特別なレース。',
    },
    { grade: ['GⅠ'],
        stage: 'S級決勝',
        stageByOddspark: 'Ｓ級決勝',
        priority: 9,
        description: 'GⅠの最終日に行われる決勝レース。優勝すると、その年のグランプリ出場権を得る。',
    },
    ...
    { grade: ['GⅡ'],
        ...
        stageByOddspark: 'Ｓ級決勝',
        priority: 8,
        description: 'GⅡの最終日に行われる決勝レース。高額賞金が用意され、競輪の中でも重要なレースの一つ。',
    },
    ...
    { grade: ['GⅢ'],
        ...
        stageByOddspark: 'Ｓ級決勝',
        priority: 8,
        description: 'GⅢの最終日に行われる決勝レース。そこそこ賞金が高く、競輪の中でも重要なレースの一つ。',
    },
    ...
    { grade: ['FⅠ'],
        ...
        stageByOddspark: 'Ｓ級決勝',
        priority: 4,
        description: 'FⅠの最終日に行われる決勝レース。ウィナーズカップの出場権に近づく。',
    },
