...
import type { AutoracePositionNumber } from './data/common/commonPositionNumber';
import type { BoatracePositionNumber } from './data/common/commonPositionNumber';
import type { KeirinPositionNumber } from './data/common/commonPositionNumber';
