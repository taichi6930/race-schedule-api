...
export type PlaceHeldDayInsert = Omit<PlaceHeldDayRow, 'created_at' | 'updated_at'>;
export type PlaceMasterInsert = Omit<PlaceMasterRow, 'created_at' | 'updated_at'>;
 ...
 */
export type PlaceUpdate = Partial<Omit<PlaceRow, 'place_id' | 'created_at' | 'updated_at'>>;
export type PlaceGradeUpdate = Partial<Omit<PlaceGradeRow, 'place_id' | 'created_at' | 'updated_at'>>;
export type PlaceHeldDayUpdate = Partial<Omit<PlaceHeldDayRow, 'place_id' | 'created_at' | 'updated_at'>>;
export type PlaceMasterUpdate = Partial<Omit<PlaceMasterRow, 'race_type' | 'course_code_type' | 'place_name' | 'created_at' | 'updated_at'>>;
export type PlayerUpdate = Partial<Omit<PlayerRow, 'race_type' | 'player_no' | 'created_at' | 'updated_at'>>;
export type RaceUpdate = Partial<Omit<RaceRow, 'race_id' | 'created_at' | 'updated_at'>>;
