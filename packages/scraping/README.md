...
- **テスト環境**: `https://race-schedule-scraping-test.<your-subdomain>.workers.dev`
- **本番環境**: `https://race-schedule-scraping-prod.<your-subdomain>.workers.dev`
...
```bash
curl https://race-schedule-scraping-test.<your-subdomain>.workers.dev/health
```
...
```bash
curl "https://race-schedule-scraping-test.<your-subdomain>.workers.dev/scraping/place?startDate=2026-01-01&finishDate=2026-12-31&raceTypeList=JRA"
```
...
```bash
curl "https://race-schedule-scraping-test.<your-subdomain>.workers.dev/scraping/race?startDate=2026-01-27&finishDate=2026-01-29&raceTypeList=JRA&location=東京"
```
