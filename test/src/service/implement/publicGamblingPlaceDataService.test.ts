...
describe('PublicGamblingPlaceDataService', () => {
    ...
    beforeEach(() => {
        ...
        container.registerInstance<IOldPlaceRepository<JraPlaceEntity>>(
        ...
        container.registerInstance<IOldPlaceRepository<NarPlaceEntity>>(
