...
describe('RaceCalendarUseCase', () => {
    ...
    describe('getRacesFromCalendar', () => {
        it('CalendarDataのリストが正常に返ってくること', async () => {
            ...
            const param = commonParameterMock();
            ...
            ).toHaveBeenCalledWith(param, searchCalendarFilter);
    ...
    //     const mockRaceEntityList = RACE_TYPE_LIST_ALL_FOR_AWS.flatMap(
    //         (raceType) =>
    ...
    //     const expectDeleteCalendarDataList = RACE_TYPE_LIST_ALL_FOR_AWS.flatMap(
    //         (raceType) =>
